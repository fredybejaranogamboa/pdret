...
<fieldset>
    <?php echo $this->Form->create("Asociation", array('novalidate'=>'','id'=>'formulario','role'=>"form","class" => "form", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $proyect_id))); ?>
    <h3>Datos asociación</h3>
    <div>
        <?php echo $this->Form->hidden('Asociation.proyect_id', array('value' => $proyect_id)); ?>
        <?php echo $this->Form->input('Asociation.nombre', array('label' => 'Nombre', 'required' => '', 'class'=>'form-control')); ?>
        <?php echo $this->Form->input('Asociation.tipo', array('label' => 'Tipo', 'required' => '', 'class'=>'form-control', 'empty' => '', 'options' =>array(
    ...
    <table border="0">
        <tbody>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.existencia', array('label' => 'Certificado de existencia y representación legal',
                    'class'=>'form-control',
            ...
            <tr>
                <td>RUT</td>
                <td><?php echo $this->Form->file('Asociation.rut', array('label' => 'RUT', 'accept' => 'pdf', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.cedulaRepresentante', array('label' => 'Cédula representante legal', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.certificado', array('label' => 'Certificado asociación', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.experiencia', array('label' => 'Soporte experiencia', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                <td>Credencial</td>
                <td><?php echo $this->Form->file('Asociation.credencial', array('label' => 'Credencial', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.facultad_representante', array('label' => 'Acto administrativo', 'class'=>'form-control',                    
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.posesion', array('label' => 'Acta de posesión', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.cdp', array('label' => 'Certificado disponibilidad presupuestal', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $this->Form->file('Asociation.f28', array('label' => 'Caracterización social población beneficiaria', 'class'=>'form-control',
                    'accept' => 'application/pdf',
                    'aria-required' => 'true',
                    'extension' => 'pdf')); ?></td>
            </tr>
