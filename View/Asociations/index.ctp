    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="dataTable_wrapper">
                    ...
                    <tbody>
                        <?php foreach ($Asociations as $Asociation): ?>
                            <tr>
                                ...
                                <td><?php echo $this->Ajax->link(' Editar', array('controller' => 'Asociations', 'action' => 'edit', $Asociation["Asociation"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'btn btn-success fa fa-pencil')); ?></td>
                ...
                <?php if ($permitir) echo $this->Ajax->link("  Adicionar", array('controller' => 'Asociations', "action" => "add", $proyect_id), array('update' => 'content', 'indicator' => 'loading', 'class' => 'btn btn-success fa fa-plus-square-o')) ?>
            </div>
        </div>
    </div>
</div>