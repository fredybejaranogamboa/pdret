...
<div class="panel-body">
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php echo $this->Form->input('Proyect.tipo', array('label' => 'Tipo', 'class' => 'form-control', 'required' => '', 'empty' => 'Seleccione un tipo', 'options' => array('F' => 'Familiar', 'A' => 'Asociativo', 'T' => 'Territorial', 'R' => 'Resguardo'))); ?>
