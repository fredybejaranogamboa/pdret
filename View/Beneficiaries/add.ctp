...
<fieldset>
    ...
    <?php echo $this->Form->input('Beneficiary.tipo', array('label' => 'Tipo beneficiario', 'class' => 'form-control', 'required' => '', 'empty' => '', 'id' => 'tipo', 'options' => array('Campesino' => 'Campesino', 'Victima' => 'Victima'))); ?>
    ...
    foreach ($asociations as $asociation) {
        $optionsAsociations[$asociation['Asociation']['id']] = $asociation['Asociation']['nombre'] . " NIT " . $asociation['Asociation']['nit'];
    }
    echo $this->Form->input('Beneficiary.asociation_id', array('label' => 'Asociación a la que pertenece', 'empty' => 'Seleccione una asociación', 'options' => $optionsAsociations, 'class' => 'form-control'));
    ?>
    <?php
    //creo el array de options para el select incluyendo los aspirantes principales
    ...
    ?>
    <?php echo $this->Form->input('Beneficiary.departament_id', array('label' => ' Departamento', 'required' => '', 'class' => 'form-control', 'empty' => 'Seleccione departamento', 'options' => $departaments)); ?>
    <div id="ciudades">
        <?php
